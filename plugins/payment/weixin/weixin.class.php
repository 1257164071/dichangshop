...
//
////        $s = serialize(array(
////            'appid' =>  'wxa2b17e89839bd8f7',
////            'mchid' =>  '1480334982',
////            'key'   => '6412121cbb2dc2cb9e460cfee7046be2' ,
////            'appsecret' =>  '2c04424976fc9c76b6936cc4aebca34e',
////        ));
////        $paymentPlugin = M('Plugin')->where("code='weixin' and  type = 'payment' ")->setField('config_value',$s);
////        dump($paymentPlugin);die;
//
...
//     //     WxPayConfig::$smchid = isset($config_value['mchid']) ? $config_value['mchid'] : '';
